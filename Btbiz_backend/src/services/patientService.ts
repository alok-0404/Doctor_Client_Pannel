...
export const getFullPatientHistory = async (patientId: string) => {
  ...
  return {
    ...
    medicineRequests: medicineRequests.map((m) => ({
      ...
      subtotal: (m as any).subtotal,
      totalDiscount: (m as any).totalDiscount,
      totalAmount: (m as any).totalAmount,
      paidAmount: (m as any).paidAmount,
      isSubstitute: !!(m as any).isSubstitute,
      substituteMedicineName: (m as any).substituteMedicineName,
      substituteNotes: (m as any).substituteNotes,
